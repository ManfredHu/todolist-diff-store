...
| Comparison Aspect | Redux                                   | Reduck                                        | Zustand                                    | Jotai                                     |
| ----------------- | ------------------------------------- | --------------------------------------------- | ----------------------------------------- | ----------------------------------------- |
...
| Open Source       | Yes, https://github.com/reduxjs/redux | Yes, https://github.com/web-infra-dev/reduck | Yes, https://github.com/pmndrs/zustand | Yes, https://github.com/pmndrs/jotai |
